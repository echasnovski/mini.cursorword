...
<!-- [![GitHub tag](https://badgen.net/github/tag/echasnovski/mini.cursorword)](https://github.com/echasnovski/mini.cursorword/tags/) -->
<!-- [![Current version](https://badgen.net/badge/Current%20version/development/cyan)](https://github.com/echasnovski/mini.cursorword/blob/main/CHANGELOG.md) -->
<!-- badges: end -->

**Automatic highlighting of word under cursor (displayed after customizable delay)**

See more details in [help file](doc/mini-cursorword.txt).
...
<table>
    ...
    <tbody>
        ...
        <!-- <tr> -->
        <!--     <td rowspan=2>Standalone plugin</td> <td>Main</td> <td><code>use 'echasnovski/mini.cursorword'</code></td> -->
        <!-- </tr> -->
        <!-- <tr> -->
        <!--     <td>Stable</td> <td><code>use { 'echasnovski/mini.cursorword', branch = 'stable' }</code></td> -->
        <!-- </tr> -->
    </tbody>
</table>
